    ...
    public partial class Question : System.Web.UI.Page
    {
        ...
        protected void btnQuestionsSave_Click(object sender, EventArgs e)
        {
            ...
            if (btnQuestionsSave.Text == "Save Question")
            {
                ...
                if (IsOtherLanguage(ddlSubject.SelectedValue))
                {
                    ...
                    qur = "Exec proc_AddQuestions '','" + ddlSubject.SelectedValue + "','" + ddlConcepts.SelectedValue + "','" + ddlObjectives.SelectedValue + "',N" + "'" + question + "','" + ddlAnswerType.SelectedValue + "',N" + "'" + answer + "','','3','Insert'";
                }
                else
                {
                    ...
                    qur = dbLibrary.idBuildQuery("[proc_AddQuestions]", "", ddlSubject.SelectedValue, ddlConcepts.SelectedValue, ddlObjectives.SelectedValue, question, ddlAnswerType.SelectedValue, answer, "", "3", "Insert");
                }
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (IsOtherLanguage(ddlSubject.SelectedValue))
                    {
                        ...
                        qur = "Exec proc_AddQuestions '" + Session["QuestionId"].ToString() + "','" + ddlSubject.SelectedValue + "','" + ddlConcepts.SelectedValue + "','" + ddlObjectives.SelectedValue + "',N" + "'" + question + "','" + ddlAnswerType.SelectedValue + "',N" + "'" + answer + "','','3','Update'";
                    }
                    else
                    {
                        ...
                        qur = dbLibrary.idBuildQuery("[proc_AddQuestions]", Session["QuestionId"].ToString(), ddlSubject.SelectedValue, ddlConcepts.SelectedValue, ddlObjectives.SelectedValue, question.Trim(), ddlAnswerType.SelectedValue, answer.Trim(), "", "3", "Update");
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string qry = dbLibrary.idBuildQuery("[proc_AddOptions]", "", ddlAnswerType.SelectedValue == "3" ? "~/testImages/" + fileName : answer.Replace("''", "'"), Session["QuestionId"].ToString(), radbtnOptionSet.Checked == true ? "1" : "0", "", "3", "Insert");
        ...
        protected void btnContinue_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                qur = dbLibrary.idBuildQuery("[proc_AddQuestions]", Session["QuestionId"].ToString(), ddlSubject.SelectedValue, ddlConcepts.SelectedValue, ddlObjectives.SelectedValue, question, ddlAnswerType.SelectedValue, answer, "", "3", "Update");
            }
            dbLibrary.idExecute(qur);
                        ...
                        else
                        {
                            if (ddlAnswerType.SelectedValue == "1")
                            {
                                ...
                                else
                                {
                                    ...
                                    string qry = dbLibrary.idBuildQuery("[proc_AddOptions]", btnDelete.CommandArgument, txtOption.Text.Replace("'", "`"), Session["QuestionId"].ToString(), radbtnOption.Checked == true ? "1" : "0", "", "3", "Update");
                                    dbLibrary.idExecute(qry);
                                }
