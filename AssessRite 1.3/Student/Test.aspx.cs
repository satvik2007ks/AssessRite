...
namespace AssessRite_1._3.Student
{
    public partial class Test : System.Web.UI.Page
    {
        ...
        private void LoadPaletteColor()
        {
            ...
            string qur1 = "SELECT  TestQuestions.QuestionNo FROM StudentAnswers LEFT OUTER JOIN TestQuestions ON StudentAnswers.TestQuestionId = TestQuestions.TestQuestionId Where StudentAnswers.TestAssignedId = '" + hdnTestAssignedId.Value + "'";
