    ...
    public partial class Question : System.Web.UI.Page
    {
        ...
        protected void btnQuestionsSave_Click(object sender, EventArgs e)
        {
            ...
            if (btnQuestionsSave.Text == "Save Question")
            {
                ...
                if (IsOtherLanguage(ddlSubject.SelectedValue))
                {
                    ...
                    qur = "Exec proc_AddQuestions '','" + ddlSubject.SelectedValue + "','" + ddlConcepts.SelectedValue + "','" + ddlObjectives.SelectedValue + "',N" + "'" + question + "','" + ddlAnswerType.SelectedValue + "',N" + "'" + answer + "','" + Session["DEId"].ToString() + "','1','Insert'";
                }
                else
                {
                    ...
                    qur = dbLibrary.idBuildQuery("[proc_AddQuestions]", "", ddlSubject.SelectedValue, ddlConcepts.SelectedValue, ddlObjectives.SelectedValue, question, ddlAnswerType.SelectedValue, answer, Session["DEId"].ToString(), "1", "Insert");
                }
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (IsOtherLanguage(ddlSubject.SelectedValue))
                    {
                        ...
                        qur = "Exec proc_AddQuestions '" + Session["QuestionId"].ToString() + "','" + ddlSubject.SelectedValue + "','" + ddlConcepts.SelectedValue + "','" + ddlObjectives.SelectedValue + "',N" + "'" + question + "','" + ddlAnswerType.SelectedValue + "',N" + "'" + answer + "','" + Session["DEId"].ToString() + "','1','Update'";
                    }
                    else
                    {
                        ...
                        qur = dbLibrary.idBuildQuery("[proc_AddQuestions]", Session["QuestionId"].ToString(), ddlSubject.SelectedValue, ddlConcepts.SelectedValue, ddlObjectives.SelectedValue, question.Trim(), ddlAnswerType.SelectedValue, answer.Trim(), Session["DEId"].ToString(), "1", "Update");
        ...
        protected void btnContinue_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                qur = dbLibrary.idBuildQuery("[proc_AddQuestions]", Session["QuestionId"].ToString(), ddlSubject.SelectedValue, ddlConcepts.SelectedValue, ddlObjectives.SelectedValue, question, ddlAnswerType.SelectedValue, answer, Session["DEId"].ToString(), "1", "Update");
            }
            dbLibrary.idExecute(qur);
